...
class EdgeInference:
    ...
    def __init__(self, weights, device='cpu', imgsz=640, conf_thres=0.25, 
                 iou_thres=0.45, max_det=300, half=False, dnn=False):
    ...
    def _allocate_trt_buffers(self):
        ...
        for i in range(self.model.num_bindings):
            binding = self.model.get_binding_name(i)
    ...
    def _load_tflite(self):
        ...
        try:
            ...
            self.model = tflite.Interpreter(model_path=str(self.weights), 
                                            num_threads=4)
